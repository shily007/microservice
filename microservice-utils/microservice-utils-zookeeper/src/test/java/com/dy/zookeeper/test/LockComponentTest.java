...
import com.dy.zookeeper.lock.BaseLockHandler;
import com.dy.zookeeper.lock.ShardReentrantLockComponent;
...
public class LockComponentTest {
	...
	/**
	 * 不加锁实现多个线程同时对 count 执行 ++ 操作 会出现数据不一致现象
	 * 
	 * @throws Exception
	 */
	@Test
